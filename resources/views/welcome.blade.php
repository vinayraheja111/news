                ...
                <div class="col-md-8">
                    ...
                    <div class="post-container">
                        <div class="post-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="post-img" href="single.php"><img src="{{asset('assets/images/post-format.jpg')}}" alt=""/></a>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="post-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="post-img" href="single.php"><img src="{{asset('assets/images/post_1.jpg')}}" alt=""/></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        <h3><a href='single.php'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</a></h3>
